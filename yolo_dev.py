...
def _setEnv() -> None:
  share = os.path.abspath("""/home/AsgerJon/.local/share/""")
  instances = os.path.join(share, 'PrismLauncher', 'instances')
  runningInstance = os.path.join(instances, '1.21.11_B')
  minescript = os.path.join(runningInstance, 'minescript')
  os.environ['MINECRAFT_INSTANCE'] = runningInstance
  os.environ['MINESCRIPT_FOLDER'] = minescript
